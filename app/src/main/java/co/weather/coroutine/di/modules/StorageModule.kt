...
import co.weather.coroutine.data.storage.EncryptedSharedPreferences
import co.weather.coroutine.data.storage.NormalSharedPreferences
...
abstract class StorageModule {
    ...
    companion object {
        @Provides
        fun provideRoomDatabase(@ApplicationContext context: Context): WeatherDatabase = WeatherDatabase.invoke(context)
